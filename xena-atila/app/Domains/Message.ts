...
export default class Message {
  ...
  constructor (
    ...
    this.from = from ? validString(from, 'BAD_MESSAGE_ID', 'NON_EMPTY') : null
    this.to = to ? validString(to, 'BAD_MESSAGE_ID', 'NON_EMPTY') : null
    this.subject = validString(subject, 'BAD_MESSAGE_ID', 'NON_EMPTY')
    this.content = validString(content, 'BAD_MESSAGE_ID', 'NON_EMPTY')
